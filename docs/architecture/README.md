...
| [problems_and_decisions.md](problems_and_decisions.md) | **겪은 문제와 내린 판단 — 중요도 순.** 사고 30건(S/A/B) · 네 단계 실패담 · 질문 묶음별 "정의 한 문장 + 코드 한 문장"(정합성·분산 / LLM·에이전트 / 측정 / 아키텍처 선택·대안·대가 / 규제 자세) · 횡단 교훈 · 열린 것 · **문서-코드 어긋남 정정표** |
